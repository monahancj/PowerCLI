...
#>
	...
	process {
		...
		$VM | Select-Object Name, `
							@{ n = "IPaddress"; e = { ($_.ExtensionData.Guest.IpStack.iprouteconfig | Select-Object -ExpandProperty iproute | Where-Object { $_.PrefixLength -match "24|32" } | Select-Object -ExpandProperty network)[1] } }, `
							@{ n = "Gateway"; e = { ($_.ExtensionData.Guest.IpStack.iprouteconfig | Select-Object -ExpandProperty iproute | Where-Object { $_.PrefixLength -match "24|32" } | Select-Object -ExpandProperty network)[2] } }
